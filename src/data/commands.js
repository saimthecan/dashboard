const commands = [
    ...
    },
    {
        ...
        "description": "Builds the app for production to the build folder. It correctly bundles React in production mode and optimizes the build for the best performance.",
    ...
    },
    {
        ...
        "description": "Runs the test watcher in an interactive mode. (Note that we haven't implemented any tests - this command is by default from the create-react-app)",
    ...
    },
    {
        ...
        "description": "This command will remove the single build dependency from your project. Important! We don't recommend using this command because our product may break after using it.",
